                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-3">
                                <div>
                                    ...
                                    <x-text-input type="text"
                                        ...
                                        id="car_type" name="car_type" value="{{ old('car_type', $cars->car_type) }}"/>
                                </div>
                                <div>
                                    <x-input-label for="destination" class="block text-sm font-medium mb-1">{{__('Destination') }}</x-input-label>
                                    <x-text-input type="text"
                                        class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2"
                                        id="destination" name="destination" value="{{ old('destination', $cars->destination) }}"/>
                                </div>
                                ...
                                <div>
                                    ...
                                    <x-text-input type="text"
                                        class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2"
                                        id="pickup_location_wise" name="pickup_location_wise" value="{{ old('pickup_location_wise', $cars->pickup_location_wise) }}"/>
                                </div>
                                ...
                                <div>
                                    ...
                                    <x-text-input type="text"
                                        class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2"
                                        id="pickup_sightseen_point" name="pickup_sightseen_point" value="{{ old('pickup_sightseen_point', $cars->pickup_sightseen_point) }}"/>
                                </div>
                                ...
                                <div>
                                    ...
                                    <x-text-input type="text"
                                        class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2"
                                        id="drop_location_wise" name="drop_location_wise" value="{{ old('drop_location_wise', $cars->drop_location_wise) }}" />
                                </div>
                                ...
                                <div>
                                    ...
                                    <x-text-input type="text"
                                        class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2"
                                        id="drop_sightseen_point" name="drop_sightseen_point" value="{{ old('drop_sightseen_point', $cars->drop_sightseen_point) }}" />
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-3">
                                <div>
                                    ...
                                    <x-text-input type="number"
                                        class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2"
                                        id="price" name="price" value="{{ old('price', $cars->price) }}" />
                                </div>
                                <div>
                                    <x-input-label for="pick_session_price" class="block text-sm font-medium mb-1">{{__('Pick Session Price') }}</x-input-label>
                                    <x-text-input type="number"
                                        class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2"
                                        id="pick_session_price" name="pick_session_price" value="{{ old('pick_session_price', $cars->pick_session_price) }}" />
                                </div>
                                ...
                                <div>
                                    ...
                                    <x-text-input type="number"
                                        class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2"
                                        id="off_session_price" name="off_session_price" value="{{ old('off_session_price', $cars->off_session_price) }}" />
                                </div>
                            </div>
