    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('admin.hotel.category')" :active="request()->routeIs('admin.hotel.category')">
                        {{ __('Add Hotel') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('admin.hotels.list')" :active="request()->routeIs('admin.hotels.list')">
                        {{ __('Hotel List') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('admin.hotel.rooms.list')" :active="request()->routeIs('admin.hotel.rooms.list')">
                        {{ __('Hotel Room List') }}
                    </x-nav-link>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('admin.ferry')" :active="request()->routeIs('admin.ferry')">
                        {{ __('Ferry Rent') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('admin.sightseeing.index')" :active="request()->routeIs('admin.sightseeing.index')">
                        {{ __('Sightseeing') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link :href="route('admin.profile.update')">
                            {{ __('Profile') }}
                        </x-dropdown-link>
